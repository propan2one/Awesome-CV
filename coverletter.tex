...
Après plusieurs années dans la recherche académique à l’étude des interactions hôtes et pathogènes, je souhaite maintenant intégrer une équipe de Recherche et Développement sur des sujets à l’interface entre immunologie et bio-informatique sur des sujets plus ambitieux.

\lettersection{Pourquoi travailler à Stem Genomics}

Les thérapies cellulaires personnalisées sont amenées à se développer en cancérologie et en médecine régénérative dans les prochaines années et donc implicitement l'analyse et le contrôle de l'intégrité cellulaire dans ces traitements sont eux aussi amenés à augmenter. De plus, il semble que votre travail valorise le domaine académique, comme le montre des publications d'articles scientifiques, en parallèle de vos activités d'entreprise.
