...
%---------------------------------------------------------
  \cventry
    ...
    {\href{https://www.microbiologyresearch.org/}{Evaluation of tangential flow filtration (TFF) coupled with Oxford Nanopore Technologies (ONT) sequencing for Ostreid herpesvirus type 1 whole-genome reconstruction, Microbial Genomics.}} % Organization
